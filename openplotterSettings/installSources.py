...
def main():
	try:
		...
		codename_alternative_debian = 'trixie'
		...
		if hostID != 'ubuntu' and hostID != 'debian':
			...
			return
		if hostID == 'debian' and (codeName != codename_debian or codeName != codename_alternative_debian):
			print(_('Current Debian version:')+' '+codeName)
			print(_('FAILED. This version of OpenPlotter only works on this version(s) of Debian:')+' '+codename_debian+' / '+codename_alternative_debian)
			return
